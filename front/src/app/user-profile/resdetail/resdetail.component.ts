...
export class ResdetailComponent implements OnInit {
  public category = '';
  public results = [];
  constructor(private route: ActivatedRoute, private resservice: ResultService , private router: Router) { }
  ...
  viewprofile(email) {
    this.router.navigate ( [ 'userprofile/viewprofile', {email: email} ] );
  }
}
